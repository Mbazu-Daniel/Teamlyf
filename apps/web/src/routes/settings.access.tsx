  ...
  return (
    <div className="space-y-6">
      <section className="rounded-xl border bg-card p-5">
        ...
        <div className="mt-5 rounded-lg border bg-muted/30 p-4"><p className="text-xs uppercase tracking-wide text-muted-foreground">Your role</p><p className="mt-1 text-lg font-semibold capitalize">{memberRole}</p></div>
      </section>
      <section className="rounded-xl border bg-card p-5">
