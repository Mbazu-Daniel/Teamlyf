...
function Home() {
  ...
  return <main className="min-h-screen bg-background text-foreground">
    <header className="border-b bg-card"><div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4"><div className="flex items-center gap-2 font-semibold"><IconRocket className="size-5" />Teamlyf</div><div className="flex items-center gap-3"><div className="flex items-center gap-2 text-sm text-muted-foreground"><IconBuilding className="size-4" />{current.name}</div><Link to="/settings/organization" className="text-sm font-medium hover:underline">Settings</Link></div></div></header>
