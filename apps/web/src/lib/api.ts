...
export function organizationPath(organizationId: string, resource: string, suffix = "") {
...
export function organizationClient(organizationId: string) {
  return {
    get: <T>(resource: string, suffix = "", options?: RequestOptions) =>
      request<T>(organizationPath(organizationId, resource, suffix), { ...options, method: "GET" }),
    post: <T>(resource: string, suffix = "", options: RequestOptions = {}) =>
      request<T>(organizationPath(organizationId, resource, suffix), { ...options, method: "POST" }),
    patch: <T>(resource: string, suffix = "", options: RequestOptions = {}) =>
      request<T>(organizationPath(organizationId, resource, suffix), { ...options, method: "PATCH" }),
  };
}
...
export const client = {
  ...
  getOrganization: (organizationId: string) => request<Organization>(organizationPath(organizationId, "")),
};
